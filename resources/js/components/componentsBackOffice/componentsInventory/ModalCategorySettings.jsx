...
const ModalCategorySettings = ({ editableCateory, saveCategoryConfig, selectCategory }) => {
            ...
            ${nameAlert} ${statusAlert}`,
                ...
                if (result.isConfirmed) {
                    ...
                    if (selectCategory.length > 0) {
                        response = await UpdateCategory(formData, selectCategory);
                    } else {
                        response = await UpdateCategory(formData, false);
                    }
            ...
            <div className="modal-dialog modal-gl">
                <div className="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" className="btn btn-orangeWeb" data-bs-dismiss="modal" onClick={() => saveConfigChanges(editableCateory.id)}>Guardar cambios</button>

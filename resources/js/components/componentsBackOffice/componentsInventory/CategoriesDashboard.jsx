...
const CategoriesDashboard = ({ allCategories, saveCategoryConfig, createNewCategory }) => {
  ...
  function selectCategorySetting(id, event) {
    let arrayProduct = selectCategory;

    if (event.target.checked) {
      arrayProduct = [...arrayProduct, id];
      setSelectCategory(arrayProduct.splice(" "));
    } else {
      let deleteArray = arrayProduct.filter(function(product) {
        return id !== product;
      })
      setSelectCategory(deleteArray);
    }
  }
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" onClick={(event) => selectCategorySetting(category.id, event)} />
                                <label class="form-check-label" for="flexCheckDefault">
                                </label>
                              </div>
                            </td>

                            <ModalCategorySettings key={category.id} editableCateory={category} saveCategoryConfig={saveCategoryConfig} selectCategory={selectCategory} />
                          </tr>
                        )

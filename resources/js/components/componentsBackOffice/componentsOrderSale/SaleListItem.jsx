...
const SaleListItem = ({sale, setSaleStatus}) =>{
    ...
    return(
        <tr>
            ...
            <td>{sale.created_at.split('/')[2]+"/"+sale.created_at.split('/')[1]+"/"+sale.created_at.split('/')[0]}</td>
            <td>
            <div className="d-flex justify-content-center">
                <button className="btn btn-outline-success p-1 me-1" data-bs-toggle="modal"
                data-bs-target="#modaleditor"><i className="bi bi-pencil fs-7"></i></button>
            ...
            <ModalSaleSettings key={sale.id} sale={sale} setSaleStatus={setSaleStatus}/>

...
const TurnDashboardListItem = ({ turn, editTurnSchedule, orderByDate, setTurnStatus, selectItem, selectItemTable }) => {
        ...
        <tr>
            ...
            <td>
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" onClick={(event) => selectItem(turn.id, event)} />
                    <label class="form-check-label" for="flexCheckDefault">
                    </label>
                </div>
            </td>

            <ModalTurnListEditor key={turn.id + "editor"} turn={turn} editTurnSchedule={editTurnSchedule} orderByDate={orderByDate} selectItemTable={selectItemTable}/>
            <ModalTurnListSettings key={turn.id + "setting"} turn={turn} editTurnSchedule={editTurnSchedule} orderByDate={orderByDate} setTurnStatus={setTurnStatus} selectItemTable={selectItemTable} />

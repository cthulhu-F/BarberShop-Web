...
import { UpdateConfigTurn } from "../../../helpers/TurnHelpers";
import swal from "sweetalert2";
import { useEffect } from "react";


const ModalChairsConfig = ({ editableChair, saveChairConfig, selectItemTable }) => {
            ...
            ${nameAlert} ${statusAlert}`,
                ...
                if (result.isConfirmed) {
                    ...
                    if (selectItemTable.length > 0) {
                        response = await UpdateConfigTurn(formData, selectItemTable);
                    } else {
                        formData.append('id', editableChair.id);
                        response = await UpdateConfigTurn(formData, false);
                    }
    ...
    useEffect(() => {
        ...
        function checkChairStatus() {
            ...
            if (editableChair.status == "ACTIVE") {
                try {
            ...
            <div className="modal-dialog modal-gl">
                <div className="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" className="btn btn-orangeWeb" data-bs-dismiss="modal" onClick={() => saveConfigChanges()}>Guardar cambios</button>
